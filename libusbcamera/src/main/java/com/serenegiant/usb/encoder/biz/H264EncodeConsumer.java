...
public class H264EncodeConsumer extends Thread {
    ...
    // 间隔1s插入一帧关键帧
    private static final int FRAME_INTERVAL = 0;
    // 绑定编码器缓存区超时时间为10s
    ...
    public boolean setRawYuv(byte[] yuvData, int width, int height) {
            ...
            do {
                ...
                if (outputBufferIndex == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    if (sync) {
                        ...
                        JadeLog.e(this, "关键帧 h264.length = " + h264.length + ";mPpsSps.length=" + mPpsSps.length
                                + "  bufferInfo.size = " + bufferInfo.size + "index = "+String.valueOf(index));
                    } else {
                        ...
                        JadeLog.e(this, "普通帧 h264.length = " + h264.length + "  bufferInfo.size = " + bufferInfo.size+" index=" + String.valueOf(index));
    ...
    public void startMediaCodec() {
        ...
        if (videoCodecInfo == null) {
            JadeLog.e(this, "Unable to find an appropriate codec for " + MIME_TYPE);
            return;
        }
    ...
    private int calcBitRate() {
        ...
        JadeLog.v(this, String.format("bitrate=%5.2f[Mbps]", bitrate / 1024f / 1024f));
        return bitrate;
    }
    ...
    protected static final int selectColorFormat(final MediaCodecInfo codecInfo, final String mimeType) {
        ...
        if (result == 0)
            JadeLog.e("selectColorFormat", "couldn't find a good color format for " + codecInfo.getName() + " / " + mimeType);
        return result;
    }
